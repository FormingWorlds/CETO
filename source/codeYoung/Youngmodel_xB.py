...
# ## ADDED BY JORICK FOR TESTING
# flist = np.array([f1_ini, f2_ini, f3_ini, f4_ini, f5_ini, f6_ini, f7_ini, f8_ini, f9_ini,
#                   f10_ini, f11_ini, f12_ini, f13_ini, f14_ini, f15_ini, f16_ini, f17_ini,
#                   f18_ini, f19_ini, f20_ini, f21_ini, f22_ini, f23_ini, f24_ini, f25_ini,
#                   f26_ini, f27_ini, f28_ini, f29_ini])
# np.savetxt('testvalues_optimisation.txt', flist)
# print('======================== Testvalues saved, breaking function ========================')
# breakpoint
